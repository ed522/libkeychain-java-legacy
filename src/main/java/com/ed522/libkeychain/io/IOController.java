...
import com.ed522.libkeychain.client.Client;
...
public class IOController {
    ...
    public void clientStartTransaction(String transactionName, Client client) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        ClientTransactionController controller = new ClientTransactionController(client, ref, id);
